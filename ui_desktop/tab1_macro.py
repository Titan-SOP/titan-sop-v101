...
def render_1_1_hud():
    # ═══════════════════════════════════════════════════════════════════════════
    # [SURGICAL CHANGE] Manual Activation Button - Remove CB Upload Requirement
    # ═══════════════════════════════════════════════════════════════════════════
    if 'hud_activated' not in st.session_state:
        st.session_state.hud_activated = False
    
    if not st.session_state.hud_activated:
        st.markdown("### 🚦 宏觀風控儀表")
        if st.button("🚀 啟動風控儀表 (Activate Macro HUD)", use_container_width=True, type="primary"):
            st.session_state.hud_activated = True
            st.rerun()
        return
    
    # ═══════════════════════════════════════════════════════════════════════════
    # [ORIGINAL CODE BELOW - 100% UNCHANGED]
    # ═══════════════════════════════════════════════════════════════════════════
    # ─── 1.1 HERO BILLBOARD ──────────────────────────────────────────────────
